...
class AleoNetworkClient {
    ...
    async getDeploymentTransactionIDForProgram(
        ...
        try {
            ...
            throw new Error(
                "Error fetching deployment transaction for program."
            );
        }
    }
    ...
    async getDeploymentTransactionForProgram(
        program: Program | string
    ): Promise<TransactionModel | Error> {
        try {
    ...
    async getProgramImportNames(
        ...
        try {
            ...
            throw new Error(
                "Error fetching program imports with error: " + error
            );
        }
    }
    ...
    async getTransactions(
        height: number
    ): Promise<Array<TransactionModel> | Error> {
        try {
            return await this.fetchData<Array<TransactionModel>>(
